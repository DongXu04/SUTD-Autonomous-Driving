...
class HybridFollowerSmooth(Node):
    def __init__(self):
        ...
        self.kp_wall = 0.15
        self.kd_wall = 0.125    # derivative gain
        self.prev_error = 0.0
        self.prev_time = self.get_clock().now().nanoseconds / 1e9
        self.wall_speed = 4.5   # base wall speed
        ...
        self.forward_emergency_dist = 1.0

        # ----- Switching / transition params -----
        self.enter_gap_thresh = 1.25
        self.exit_gap_thresh = 1.75
        ...
        self.get_logger().info("HybridFollowerSmooth ready. Starting in WALL mode.")
    ...
    def scan_callback(self, scan: LaserScan):
        ...
        if self.state == 'WALL':
            if forward_dist < self.enter_gap_thresh:
                ...
                if abs(steer) < 0.4 and forward_dist > self.forward_emergency_dist:
