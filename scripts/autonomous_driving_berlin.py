...
class HybridFollowerSmooth:
    def __init__(self):
        ...
        self.desired_distance = 1.2   # desired distance to right wall (m)   [Berlin: 1.2 Levine: 0.8]
        self.kp_wall = 1.2
        self.wall_speed = 7.5
        ...
        self.wall_confidence_threshold = 0.25  # fraction of valid right-sector readings required
